...
public class SignatureHandler_bck2 implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = SignatureHandler_bck2.class.getSimpleName();
